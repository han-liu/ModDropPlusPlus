...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--val_epoch_freq', type=int, default=5, help='frequency of validation at the end of epochs')
        ...
        parser.add_argument('--loss_to_use', type=str, default='l2', help='the loss function to be used for segmentation training')
        ...
        parser.add_argument('--use_modality_dropout', action='store_false', help='use modality dropout at training phase')
        parser.add_argument('--use_dyn', action='store_false', help='use dynamic filter')
        self.isTrain = True
        return parser
